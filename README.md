...
Верстка, дизайн и материалы сайта разработаны мною с нуля. Скрипты на jQuery – тоже, за исключением тех, что указаны в «Дополнительно». Дизайн отзывчивый к размеру экрана и рассчитан на работу в браузерах IE10+/Edge, Firefox, Chrome, Opera и Safari.
