  ...
  function setImageSizes() {
    ...
    try {
      for (var _iterator3 = images[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        var size = image.getAttribute("data-size");
  ...
  function handle() {
    ...
    try {
      for (var _iterator4 = images[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        var isLoaded = image.getAttribute("data-src") == "loaded";
...
function () {
  ...
  _createClass(Modal, [{
    ...
    value: function _open() {
      ...
      setTimeout(function () {
        _this2._modal.classList.add("is-visible");
      }, 20);
    }
  }, {
    key: "_close",
...
function (_Modal) {
  ...
  function Lightbox() {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(Lightbox).call(this));
    _this4._modal = document.querySelector(".js-lightbox-toggle");
    _this4._image = _this4._modal.querySelector("img");
    _this4._duration = _this4._getDuration(_this4._modal);
    return _this4;
  }
  ...
  _createClass(Lightbox, [{
    ...
    value: function _removeImage() {
      ...
      setTimeout(function () {
        _this6._image.src = _this6._originSrc;
      }, this._duration);
    }
  }]);
...
function (_Collapse) {
  ...
  function Copy() {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(Copy).call(this));
    _this7._trigger = document.querySelector(".js-copy-url-trigger");
    _this7._field = document.querySelector(".js-copy-url-field");
    _this7._wrapper = _this7._field.parentElement;
    return _this7;
  }
    ...
    value: function handleVisibility(threshold) {
      ...
      window.addEventListener("scroll", function () {
        if (pageYOffset > threshold) {
          _this10._button.classList.add("is-active");
        } else {
          _this10._button.classList.remove("is-active");
        }
      });
    }
  }]);
